...
<body>
	...
	<section>
		<h2>application 내장객체와 같이 사용하는 메서드</h2>
	...
	<section>
		<h2>▶ application 내장 객체 실습 예</h2>
		<%
			String serverInfo = application.getServerInfo();
			String appPath = application.getContextPath();
			String file = application.getRealPath("5_application.jsp");
		%>
		...
		<ul style="padding-left:30px;">
			...
			<li> 웹 애플리케이션 텍스트명 패스명<br/>
				<b><%=appPath %></b>
			</li>
			<li>웹 애플리케이션 파일 경로 명<br/>
				<b><%=file %></b>
			</li>
